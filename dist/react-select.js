...
var Select = _react2['default'].createClass({
	...
	propTypes: {
		...
		multiSummary: _react2['default'].PropTypes.bool, // whether to display multi-value summary
	...
	toggleValue: function toggleValue(value) {
		...
		var valueArray = this.getValueArray(this.props.value);
		if (valueArray.filter(function (e) {
			return _this2.elementsEqual(e, value);
		}).length > 0) {
			this.setValue(valueArray.filter(function (e) {
				return !_this2.elementsEqual(e, value);
			}));
		} else {
			this.setValue(valueArray.concat(value));
	...
	elementsEqual: function elementsEqual(val1, val2) {
		return val1[this.props.valueKey] === val2[this.props.valueKey] && val1[this.props.labelKey] === val2[this.props.labelKey];
	},
	...
	renderValue: function renderValue(valueArray, isOpen) {
		...
		if (this.props.multi) {
			if (this.props.multiSummary) {
				var summaryText = valueArray.length + ' of ' + this.props.options.length + ' selected';
				return _react2['default'].createElement(
					ValueComponent,
					{
	...
	render: function render() {
		var valueArray = this.getValueArray(this.props.value);
		var shouldFilterOptions = this.props.multi && !this.props.multiSummary;
		var options = this._visibleOptions = this.filterOptions(shouldFilterOptions ? valueArray : null);
		...
		var needsValueArray = !this.props.multi || this.props.multi && this.props.multiSummary;
